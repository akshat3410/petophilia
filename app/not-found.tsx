...
export default function NotFound() {
  return (
    ...
    >
      <p className="text-[120px] font-black leading-none text-white/20">404</p>
      ...
      <Link
        href="/"
        className="mt-4 inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 text-[15px] font-black text-teal shadow-soft-lg transition-all hover:scale-105 active:scale-95"
